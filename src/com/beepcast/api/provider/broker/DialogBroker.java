...
public class DialogBroker extends BaseBroker {
  ...
  static final DLogContext lctx = new SimpleContext( "DialogBroker" );
  ...
  public DialogBroker( MOWorker moWorker , DRWorker drWorker ,
