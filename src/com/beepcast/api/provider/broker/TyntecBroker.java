...
public class TyntecBroker extends BaseBroker {
  ...
  static final DLogContext lctx = new SimpleContext( "TyntecBroker" );
  ...
  public TyntecBroker( MOWorker moWorker , DRWorker drWorker ,
